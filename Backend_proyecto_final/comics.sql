...
VALUES
	...
	('Deathstroke', 1, 'https://firebasestorage.googleapis.com/v0/b/comicskite.appspot.com/o/1fd98871-71cf-4ea0-847b-e3f7f242a87a?alt=media&token=056fcf5d-c847-4418-bcbd-38742e7fc6d5', 'https://firebasestorage.googleapis.com/v0/b/comicskite.appspot.com/o/405cc285-42e5-42a3-a673-8fe402dee461?alt=media&token=3abfc61d-f7a8-4158-bdca-d979d4466e3a', 'REVIEW: Explosiones, acción trepidante, una nueva y sorprendente compañera y el hijo de @#1€% más grande de todo el Universo DC. Bienvenidos a las sombras. Bienvenidos a Deathstroke Inc. Después de sufrir varias pérdidas irreparables.', 100, 91, 1),
		('Tortugas Ninja', 1, 'https://firebasestorage.googleapis.com/v0/b/comicskite.appspot.com/o/fdbdc78a-7dcb-4e99-8ab7-be5e8384fd27?alt=media&token=b8b0c62b-fe5e-4d7e-832f-e9d0bec92d5a', 'https://firebasestorage.googleapis.com/v0/b/comicskite.appspot.com/o/28a989ff-e562-4490-b2f8-8856bc45acc1?alt=media&token=011445f0-2439-4732-8582-eaacd64e3ad3', 'Las Tortugas se originaron en un pequeño cómic en blanco y negro de Kevin Eastman y Peter Laird titulado "Eastman and Laird''s Teenage Mutant Ninja Turtles." Se publicó en 1984 por Mirage Studios. Se convirtió una sensación de la noche a la mañana entre los cómics independientes. El origen de la historieta es una parodia y un homenaje al trabajo de Frank Miller.', 3000, 2000, 1),
	('Spiderman ', 600, 'https://firebasestorage.googleapis.com/v0/b/comicskite.appspot.com/o/830fa80f-5164-4209-98ae-ca9214daa95f?alt=media&token=49005236-c413-48b4-bd4e-bef8fbdf720a', 'https://firebasestorage.googleapis.com/v0/b/comicskite.appspot.com/o/3c483db7-3990-4993-b494-996eee42ebca?alt=media&token=174c5ecd-40b4-4712-b586-c56604ed9aed', 'Tía May está en el parque conversando con alguien mientras le cuenta lo orgullosa que se siente de que Peter sea un héroe y de su relación con MJ. Poco después un prototipo de traje minero con un gran poder vibratorio es robado por un personaje que se hace llamar el Agitador pero Spidey consigue derrotarlo atrapándolo entre unas olas de agua que él mismo genera con su vibración. May se despide de sus amigos, quienes resultan ser unas imágenes oníricas de Ben, Mary, y Richard Parker.', 5000, 88, 1);
